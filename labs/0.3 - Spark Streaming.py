...
peak_hours_df = (spark.read
    ...
    .orderBy( col("total_sales").desc() )  # Sort by total_sales descending
)
...
running_total_df = (streaming_df
    ...
    .agg(
        sum( "totalPrice" ).alias("total_sales"),  # Column to sum
        count( "quantity" ).alias("total_transactions"),  # Column to count
...
hourly_trends_df = (streaming_df
    ...
    .agg(
        ...
        count( "quantity" ).alias("hourly_transactions")  # Column to count
    )
)
...
traffic_performance_df = (streaming_df
    ...
    .agg(
        ...
        count( "quantity" ).alias("source_transactions"),  # Column to count
