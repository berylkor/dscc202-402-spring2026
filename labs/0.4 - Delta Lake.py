...
enhanced_df = base_df.withColumn(
    ...
    "avg_speed_mph",
    round(try_divide(col( "trip_distance" ),  unix_timestamp(col( "tpep_dropoff_datetime" )) / 60), 2)  # Distance and duration columns
)
...
silver_stream_df = (spark.readStream
    ...
    .agg(
        ...
        avg( "tpep_dropoff_datetime" ).alias("avg_trip_distance")  # Column to average
    )
)
